...
const float SimpleDriver::maxSpeedDist=275;
const float SimpleDriver::maxSpeed=1000;
const float SimpleDriver::sin5 = 0.08716;
const float SimpleDriver::cos5 = 0.99619;

/* Steering constants*/
const float SimpleDriver::steerLock=0.785398;
const float SimpleDriver::steerSensitivityOffset=400.0; // 80
const float SimpleDriver::wheelSensitivityCoeff=1;		// 1
